...
{	
	...
	{	
		...
		switch(getch())
		{
			...
			case 'd':	
						if(((x<300 && x>180) && (y>595)) || ((x<305 && x>405) && (y>500 && y<535)) || ((x<420 && x>635) && (y>445 && y<470)) || ((x<670 && x>750) && (y>390 && y<425)) || ((x<770 && x>850) && (y>435 && y<470)) || ((x<850 && x>930) && (y>560 && y<595)))
						{
							goto top;
						}
						...
						cleardevice();
						draw(x,y,a,b);
						if(((x<180 || x>300) && y==595) || ((x<295 || x>405) && y==500) || ((x<420 || x>635) && y==445) || ((x<670 || x>750) && y==390) || ((x<770 || x>850) && y==435) || ((x<850 || x>930) && y==560))
						{
						do
						{			
							y+=5;
