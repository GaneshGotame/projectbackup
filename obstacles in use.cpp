	...
	{	
		...
		switch(getch())
		{
			...
			case 'e':
						...
						do
						{
							if((x>=180 && x<=300) && (y>=595 && y<=660) || (x>=295 && x<=405) && (y>=500 && y<=535) || ((x>=420 && x<=635) && (y>=430 && y<=465)) || ((x>=670 && x<=750) && (y>=390 && y<=425)))
							{
								goto top;
							}
							setactivepage(page);
			...
			case 'd':	
						if((x<300 && x>180) && (y>595) || ((x<305 && x>405) && (y>500 && y<535)) || ((x<420 && x>635) && (y>430 && y<465)) || ((x<670 && x>750) && (y>390 && y<425)))
						{
							goto top;
						}
						setactivepage(page);
						...
						x=x+20;
						draw(x,y,a,b);
						if((x<180 || x>300) && y==595 || ((x<295 || x>405) && y==500) || ((x<420 || x>635) && y==430) || ((x<670 || x>750) && y==390))
						{
						do
						{			
							setactivepage(page);
